  ...
  useEffect(() => {
    const loadContent = async () => {
      try {
        ...
        const response = await fetch(`/content/2.2-agentes-langchain.json?v=${timestamp}`, {
          cache: 'no-cache',
          headers: {
  ...
  if (loading) {
    return (
      <PageTemplate 
        ...
        subtitle="Sistema de agentes autônomos que utilizam LLMs para decisão e execução de ações com ferramentas externas"
      >
