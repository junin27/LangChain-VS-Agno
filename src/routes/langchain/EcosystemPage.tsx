  ...
  useEffect(() => {
    const loadContent = async () => {
      try {
        ...
        const response = await fetch(`/content/2.5-ecossistema-langchain.json?t=${timestamp}`, {
          headers: {
      ...
      <div className="container mx-auto px-8 pb-8">
        <div className="max-w-7xl mx-auto">
          <div className="card p-8">
            <h1 className="text-3xl font-bold mb-4 gradient-text">Ecossistema e Integrações</h1>
