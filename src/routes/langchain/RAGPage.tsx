  ...
  useEffect(() => {
    const loadContent = async () => {
      try {
        ...
        const response = await fetch(`/content/2.4-rag-langchain.json?v=${timestamp}`, {
          cache: 'no-cache',
          headers: {
  ...
  if (loading) {
    return (
      <PageTemplate 
        ...
        subtitle="Técnica avançada que combina LLMs com bases de conhecimento externas para respostas mais precisas, relevantes e atualizadas"
      >
